...
{
    public partial class Story3_Basement : MetroForm
    {
        public static int score_story3 { get; private set; }
        Timer timer = new Timer();
        int count_down = 57;

        public Story3_Basement()
        {
            InitializeComponent();
            string path = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"..\..\Story\Story 1\Sounds\Deel 3 rustig naar kelder.wav");
